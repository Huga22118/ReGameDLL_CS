...
| mp_plant_c4_anywhere               | 0       | 0   | 1            | When set, players can plant anywhere, not only in bombsites.<br/>`0` disabled <br/>`1` enabled | sv_progressbar_when_reload         | 0       | 0   | 1            | Progress Bar will appear. <br/>`0` disabled <br/>`1` enabled
|
</details>
